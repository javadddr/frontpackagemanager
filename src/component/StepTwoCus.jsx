...
function StepTwoCus({selectedVendorId,selectedCustomerId,selectedHubId,selectedProducts,setSelectedVendorId,setSelectedCustomerId,setSelectedHubId,setSelectedProducts}) {
  ...
  return (
    <div className='flex min-h-[215px]  justify-between p-3'>
      ...
      <h3 className='text-gray-900 font-bold mb-0 text-sm'>Receiving hub</h3>
        <Input 
          clearable 
          bordered 
        ...
        />
        <div className="hub-list overflow-y-auto max-h-[215px] scrollbar-hide  p-2 pt-4">
          <AnimatePresence>
      ...
      <div className='flex-1 border-r-2 px-6'>
      <h3 className='text-gray-900 font-bold mb-0 text-sm'> Shipper (Customer)</h3>
        <Input 
          clearable 
          bordered 
                ...
                <Card>
                  <CardBody>
                    <div className="flex items-center justify-between m-1">
                      ...
                      <p className="text-gray-400 text-xs">Customer-{customer.address}</p>
