...
function StepThreeCus({ notify,setNotify,notifyWhen,setNotifyWhen,}) {
  ...
  return (
    <div className='flex h-[300px] justify-between p-3'>
      <div aria-label="Choose who to notify" className='flex-1'>
        <h3 id="who-to-notify" className='text-gray-900 text-base'>Who do you want to notify?</h3>
      ...
      <div aria-label="Choose when to notify" className='flex-1'>
        <h3 id="when-to-notify" className='text-gray-900 text-base'>When?</h3>
